        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-danger text-white">
                    <h4 class="card-title mb-0">Ajouter une salle</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('salles.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" required>
                            @error('code')
