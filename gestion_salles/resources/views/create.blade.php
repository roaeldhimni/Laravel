...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-danger text-white">Create New Machine</div>
            <div class="card-body mb-0 ">
                ...
                <form action="{{ route('machines.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="dateAchat" name="dateAchat" value="{{ old('dateAchat') }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="salleid" name="salleid" value="{{ old('salleid') }}" required>
                    </div>
